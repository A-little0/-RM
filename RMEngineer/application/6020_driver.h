...
#include "user_lib.h"
/*YAW轴pid参数相关宏定义*/
#define YAWM6020_POSITIONPID_KP 0.075f//0.07f//0.066f//0.065f
#define YAWM6020_POSITIONPID_KI 0.0015f//0.0013f//0.002f//0.002f
#define YAWM6020_POSITIONPID_KD 0.0f
#define YAWM6020_SPEEDPID_KP  365.0f//360.0f//350.0f//300.0f
#define YAWM6020_SPEEDPID_KI  0.0f
#define YAWM6020_SPEEDPID_KD  0.0f

#define YAW_INTERGRAL_VALVE 60
/*PITCH轴pid参数相关宏定义*/
#define PITCHM6020_POSITIONPID_KP 0.4f//0.15f
#define PITCHM6020_POSITIONPID_KI 0.01f//0.0001f
#define PITCHM6020_POSITIONPID_KD 0.0f//0.1f
#define PITCHM6020_SPEEDPID_KP 310.0f//30.0f
#define PITCHM6020_SPEEDPID_KI  0.0f//15.0f
#define PITCHM6020_SPEEDPID_KD  0.0f//10.0f

#define PITCH_INTERGRAL_VALVE 100
