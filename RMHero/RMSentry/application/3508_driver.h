...
#define USING_SMOOTHING_FILTER 0// 1为开启  0为关闭
	...
	/*位置PID*/							     //3
	#define M3508_ID1_SPEEDPID_POSITION_KP   0.0f
	#define M3508_ID1_SPEEDPID_POSITION_KI    0.0f
	#define M3508_ID1_SPEEDPID_POSITION_KD    0.0f

	#define M3508_ID2_SPEEDPID_POSITION_KP   0.0f
	#define M3508_ID2_SPEEDPID_POSITION_KI    0.0f
	#define M3508_ID2_SPEEDPID_POSITION_KD    0.0f

	#define M3508_ID3_SPEEDPID_POSITION_KP    0.0f
	#define M3508_ID3_SPEEDPID_POSITION_KI    0.0f
	#define M3508_ID3_SPEEDPID_POSITION_KD    0.0f

	#define M3508_ID4_SPEEDPID_POSITION_KP   0.0f
	#define M3508_ID4_SPEEDPID_POSITION_KI    0.0f
	...
	#define M3508_ID1_SPEEDPID_POSITION_KP   13.0f//19.0f
	#define M3508_ID1_SPEEDPID_POSITION_KI   0.01f//0.02f
	#define M3508_ID1_SPEEDPID_POSITION_KD   0.0f//0.0f

	#define M3508_ID2_SPEEDPID_POSITION_KP   10.0f//21.0f//17.0f//15.0f
	#define M3508_ID2_SPEEDPID_POSITION_KI   0.01f//0.1f//0.009f//0.008f
	#define M3508_ID2_SPEEDPID_POSITION_KD   0.0f// 0.0f

	#define M3508_ID3_SPEEDPID_POSITION_KP   10.0f//17.0f
	#define M3508_ID3_SPEEDPID_POSITION_KI   0.01f//0.008f
	#define M3508_ID3_SPEEDPID_POSITION_KD   0.0f//0.0f

	#define M3508_ID4_SPEEDPID_POSITION_KP   12.0f//20.0f//19.0f
	#define M3508_ID4_SPEEDPID_POSITION_KI   0.05f//0.02f
	#define M3508_ID4_SPEEDPID_POSITION_KD   0.0f//0.0f
	
	/*增量PID*/
	#define M3508_ID1_SPEEDPID_DELTA_KP    50.0f
	#define M3508_ID1_SPEEDPID_DELTA_KI    1.0f
	#define M3508_ID1_SPEEDPID_DELTA_KD    0.0f

	#define M3508_ID2_SPEEDPID_DELTA_KP    30.0f
	#define M3508_ID2_SPEEDPID_DELTA_KI    0.5f
	#define M3508_ID2_SPEEDPID_DELTA_KD    0.0f

	#define M3508_ID3_SPEEDPID_DELTA_KP    0.0f
	#define M3508_ID3_SPEEDPID_DELTA_KI    0.0f
	#define M3508_ID3_SPEEDPID_DELTA_KD    0.0f

	#define M3508_ID4_SPEEDPID_DELTA_KP    0.0f
	#define M3508_ID4_SPEEDPID_DELTA_KI    0.0f
	#define M3508_ID4_SPEEDPID_DELTA_KD    0.0f	
...
#define M3508_FRITION_LEFT_SPEEDPID_DELTA_KP    50.0f
#define M3508_FRITION_LEFT_SPEEDPID_DELTA_KI    10.0f
#define M3508_FRITION_LEFT_SPEEDPID_DELTA_KD     0.0f	
#define M3508_FRITION_RIGHT_SPEEDPID_DELTA_KP    50.0f
#define M3508_FRITION_RIGHT_SPEEDPID_DELTA_KI    5.0f
#define M3508_FRITION_RIGHT_SPEEDPID_DELTA_KD    0.0f	

#define M3508_TRIGGER_SPEEDPID_DELTA_KP    15.0f
#define M3508_TRIGGER_SPEEDPID_DELTA_KI    2.0f
#define M3508_TRIGGER_SPEEDPID_DELTA_KD    0.0f	
typedef struct{
